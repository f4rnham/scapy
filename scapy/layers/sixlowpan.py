...
MAX_SIZE = 96
def fragmentate_sixlowpan(packet, datagram_tag):
    """Split a packet into different links to transmit as 6lowpan packets.
    """
    str_packet = raw(packet)
...
bind_layers( Dot15d4Data,         LoWPAN_IPHC )
